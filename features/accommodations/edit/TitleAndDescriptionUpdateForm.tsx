...
import { TitleAndDescriptionForm } from "../creation/TitleAndDescriptionForm";
import { type AccommodationUpdateFormProps } from "./AccommodationEditPage";

const TitleAndDescriptionUpdateForm: FC<AccommodationUpdateFormProps> = ({
  accommodation,
  onCancel,
  onSuccess,
  onError,
...
export default TitleAndDescriptionUpdateForm;
